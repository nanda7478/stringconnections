<?php
/*
 Display Template Name: Human Resource Service
*/
get_header();
?>
		...
		<div class="row">
			...
			<?php $image = get_field('sub_service_icon');?>
				<div class="sub_service_icon">
					...
					<h2 class="text-primary"><img src="<?php echo $image['url'];?>" class="icon" alt="<?php the_field('sub_service_title');?>"> <div> <?php the_field('sub_service_title');?> </div> </h2>
				</div>
