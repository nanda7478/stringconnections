<?php
/*
 Display Template Name: Training Solution Service
*/
get_header();
?>

<section class="sub_service_section sub_service_section page_section">
	<div class="container">
		<div class="row">
			...
			<?php $image = get_field('sub_service_icon');?>
				...
				<div class="light_box_content">
					...
					<?php
					$i=1;
					while(have_rows('light_box_section')): the_row();
					?>
						<li>
					<a class="subservice" href="javascript:;" data-toggle="modal" data-target="#exampleModal<?php echo $i;?>" class="youTubeVideo"><?php the_sub_field('lightbox_title');?><i class="fa fa-chevron-right"></i></a> 
						</li>

						<div class="modal fade light_box_content_modal" id="exampleModal<?php echo $i;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
						  <div class="modal-dialog modal-dialog-centered" role="document">
						    <div class="modal-content">
						       <button type="button" class="close" data-dismiss="modal" aria-label="Close">
						          <span aria-hidden="true"><img src="<?php bloginfo('template_url');  ?>/assets/images/popup_close.png" alt=""></span>
						        </button>
						      <div class="modal-body">
						        <div class="subserviceWrapper">
								<div class="subservice_content">
								<h2 class="text-primary"><?php the_sub_field('lightbox_title');?></h2>
